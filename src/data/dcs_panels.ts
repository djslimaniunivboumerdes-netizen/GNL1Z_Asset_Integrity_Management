...
export const DCS_PANELS: DcsPanel[] = [
  ...
  { id: "mcr-1", title_en: "MCR Refrigeration 1", title_fr: "Réfrigération MCR 1", section: "Refrigeration", unit: "X04", drive_id: "1MqVEqPzgnFnAWxlcB9dQJYqsBBoMezc", related_tags: ["X04-G-07.85", "X04-G-07.90", "X04-G-07.91"] },
  ...
  { id: "mcr-3", title_en: "MCR Refrigeration 3", title_fr: "Réfrigération MCR 3", section: "Refrigeration", unit: "X04", drive_id: "1L70xNsbAwdVEtxuSSu-26qc8NNMlb8da" },
  { id: "propane-1", title_en: "Propane Loop 1", title_fr: "Boucle Propane 1", section: "Refrigeration", unit: "X05", drive_id: "1VDBIAuIPFMpJciRysH7mHQgI4ekXAUcL", related_tags: ["X05-G-07.88", "X05-G-07.89"] },
  ...
  { id: "decarbonation-01", title_en: "Decarbonation MEA 1", title_fr: "Décarbonation MEA 1", section: "Treatment", unit: "X01", drive_id: "1yGjd33Gw6lkS8wEzbYWu4AgZBCsAxdc1", related_tags: ["X01-F-05.01", "X01-F-05.02", "X01-E-501", "X01-E-502"] },
  { id: "decarbonation-2", title_en: "Decarbonation MEA 2", title_fr: "Décarbonation MDA 2", section: "Treatment", unit: "X01", drive_id: "1ff4_y7xQNPidT48O8OTOZ2rj9lTzupbj" },
  { id: "dehydration-1", title_en: "Dehydration 1", title_fr: "Déshydratation 1", section: "Treatment", unit: "X02", drive_id: "1IYhkzaSS5hIGR-GYA8zAqjO-AHJSMwMt" },
  ...
  { id: "dehydration-3", title_en: "Dehydration 3", title_fr: "Déshydratation 3", section: "Treatment", unit: "X02", drive_id: "14NT4V5VjmszC3loQuCxfuT4jjSThHoqAY" },
  ...
  { id: "demethanisation-2", title_en: "Demethaniser 2", title_fr: "Déméthaniseur 2", section: "Fractionation", unit: "X07", drive_id: "1ujoMROHAioNA9pN_sei3EA5LHBxJmx2se" },
  { id: "deethanisation", title_en: "Deethaniser", title_fr: "Déethaniseur", section: "Fractionation", unit: "X08", drive_id: "1EYEJOXvnXaL-jxMGwVbdiRWdp0rNil-", related_tags: ["X08-F-07.31"] },
  ...
  { id: "fuel-gas-oil-console", title_en: "Fuel Gas / Oil Console", title_fr: "Console Fuel Gas / Huile", section: "Utilities", drive_id: "1pdCPONMVJBMS102khxB6SrkHSwMjATt3" },
  { id: "exchanger-recup-gpl", title_en: "GPL Recovery Exchanger", title_fr: "Échangeur récup. GPL", section: "Recovery", drive_id: "15nKWgoHdmbHC8VIU6EkggbQrmOhvWOdE" },
  ...
  { id: "op-data-t100", title_en: "Operation Data T100", title_fr: "Données opération T100", section: "Operating Data", drive_id: "1iujC-rgEHaVOikAnFnNDQkaY3z8pFyRVg" },
  { id: "op-data-t200", title_en: "Operation Data T200", title_fr: "Données opération T200", section: "Operating Data", drive_id: "14fc85LCC1CIo5a4_an6XGvFd_4ETDEc-" },
  { id: "op-data-t300", title_en: "Operation Data T300", title_fr: "Données opération T300", section: "Operating Data", drive_id: "18CcolGOL-ZEqkUdj-PDD6fP0wewZGNMi" },
  { id: "op-data-t500", title_en: "Operation Data T500", title_fr: "Données opération T500", section: "Operating Data", drive_id: "1nINTgtgIwfoi--3n77jDVY46XAySSncA" },
...
// FIXED: Use Google Drive direct view URL (more reliable than thumbnail)
