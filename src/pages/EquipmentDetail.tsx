            ...
            <div className="mt-5 pt-5 border-t border-white/20 flex flex-col sm:flex-row items-start gap-5">
              ...
              <div className="text-white/80 space-y-2 text-sm">
                ...
                <div className="flex gap-2 pt-1">
                  <button onClick={() => navigator.clipboard.writeText(pageUrl)} className="inline-flex items-center gap-1.5 text-xs bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg px-3 py-1.5 transition-colors">
                    <Copy className="h-3.5 w-3.5" /> Copy URL
                  </button>
                  <button onClick={() => window.print()} className="inline-flex items-center gap-1.5 text-xs bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg px-3 py-1.5 transition-colors">
